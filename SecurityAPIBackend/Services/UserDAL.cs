...
using SecurityAPIBackend.Helpers;
...
namespace SecurityAPIBackend.Services
{
    public class UserDAL : IUser
    {
        ...
        public UserDAL(IOptions<AppSettings> appSettings, UserManager<IdentityUser> userManager,
        ...
        public async Task<bool> CheckUserInRole(string username, string rolename)
        {
            var user = await _userManager.FindByNameAsync(username);
